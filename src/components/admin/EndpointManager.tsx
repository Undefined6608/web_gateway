...
import { DeleteOutlined, EditOutlined, GlobalOutlined, LinkOutlined, SafetyCertificateOutlined, WifiOutlined } from '@ant-design/icons'
...
export function EndpointManager({ system, onChanged }: { system: GatewaySystem; onChanged: () => void }) {
  ...
  const edit = (endpoint: Endpoint) => {
    ...
    form.setFieldsValue({ endpoint_type: endpoint.endpoint_type, url: endpoint.url, requires_vpn: endpoint.requires_vpn, is_internal_network: endpoint.is_internal_network, is_public_network: endpoint.is_public_network, remark: endpoint.remark })
  }

  const reset = () => {
    setEditingId(null)
    form.setFieldsValue({ endpoint_type: 'online', url: '', requires_vpn: false, is_internal_network: false, is_public_network: false, remark: null })
  }
  ...
  return <div className="manager-section">
    <div className="endpoint-form"><Form form={form} layout="vertical" initialValues={{ endpoint_type: 'online', requires_vpn: false, is_internal_network: false, is_public_network: false }} requiredMark={false}>
